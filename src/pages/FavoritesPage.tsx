    ...
    <div className="min-h-screen bg-background">
      ...
      <header className="sticky top-0 z-40 bg-background/95 backdrop-blur-md border-b border-border">
        <div className="flex items-center gap-4 px-4 h-14">
          ...
          <h1 className="font-display font-bold text-lg">Favorites</h1>
        </div>
      </header>
      ...
      <main className="p-4 pb-24">
        {favorites.length === 0 ? (
          ...
          >
            ...
            <h2 className="text-xl font-display font-bold mb-2">No Favorites Yet</h2>
            <p className="text-muted-foreground mb-6">Start adding your favorite items!</p>
