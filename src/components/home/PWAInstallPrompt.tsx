        ...
        >
          ...
          <div className="flex items-start gap-3.5">
            ...
            <div className="flex-1 pr-5">
              <h3 className="font-display font-bold text-amber-200 text-base mb-0.5">
                Install Kopi Klasik
              </h3>
              ...
              <div className="flex gap-2">
                {isInstallable ? (
                  <Button
                    ...
                    size="sm"
                    className="gap-1.5 rounded-full text-xs font-semibold h-8 px-5 bg-gradient-to-r from-amber-400 to-amber-500 text-stone-900 hover:from-amber-300 hover:to-amber-400 shadow-lg shadow-amber-500/30 border-0"
                  >
